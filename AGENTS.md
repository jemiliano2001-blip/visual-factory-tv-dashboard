...
- AI models allowlisted: `gemini-3.7-flash` (text/voice NLU, updated 2026-08-20 from `gemini-3.5-flash`, which stays allowlisted as a rollback path) and `gemini-3.1-flash-tts-preview` (TTS only — not interchangeable).
